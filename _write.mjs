...
const out = {A: chartToJson(chartA), B: chartToJson(chartB)};
fs.writeFileSync("C:/Users/Administrator/.hermes/scripts/_chart_data.json", JSON.stringify(out, null, 2), "utf-8");
